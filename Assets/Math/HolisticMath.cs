...
public class HolisticMath
{
    ...
    static public Vector3 Perpendicular(Vector3 vector)
    { 
    ...
    {
        //despejando:
        //Alpha = Acos(dot(v,w),||v||·||w||)
        //Otra opcion es normalizar ambos vectores y hacer Acos(dot(v,w))
    ...
    //Matemáticas para la rotación 2D (Alpha es el nuevo ángulo a sumar respecto del actual)
    // newXRot = xCos(Alpha) - ySin(Alpha)
    // newYRot = xSin(Alpha) + yCos(Alpha)
